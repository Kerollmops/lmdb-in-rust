...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    let mut sval: [libc::c_char; 32] = *::std::mem::transmute::<&[u8; 32], &mut [libc::c_char; 32]>(
    ...
    if rc == 0 as libc::c_int {
        ...
        fprintf(
            ...
            b"mtest.c\0" as *const u8 as *const libc::c_char,
            113 as libc::c_int,
            b"mdb_cursor_get(cursor, &key, &data, MDB_LAST)\0" as *const u8 as *const libc::c_char,
            mdb_strerror(rc),
        );
        abort();
    };
    ...
    if rc == 0 as libc::c_int {
        ...
        fprintf(
            ...
            b"mtest.c\0" as *const u8 as *const libc::c_char,
            129 as libc::c_int,
            b"mdb_cursor_get(cursor, &key, &data, MDB_PREV)\0" as *const u8 as *const libc::c_char,
            mdb_strerror(rc),
        );
        abort();
    };
        ...
        if rc == -(30798 as libc::c_int) || {
            if rc == 0 {
                ...
                fprintf(
                    ...
                    b"mtest.c\0" as *const u8 as *const libc::c_char,
                    151 as libc::c_int,
                    b"mdb_cursor_get(cur2, &key, &data, op)\0" as *const u8 as *const libc::c_char,
                    mdb_strerror(rc),
                );
                abort();
            };
